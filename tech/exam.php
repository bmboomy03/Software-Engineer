                ...
                <table class="table table-striped">
                    <thead>
                            <tr>
                                ...
                                <th scope="col">ตรวจสอบไฟล์</th>
                                <th scope="col">สำรองไฟล์</th>
                            </tr>
                        </thead>
                        <?php
                    $sql = "
      ...
      ";
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $row["tdate"] ?></td>    
                            <td><?= $row["estatus"] ?></td>
                            <td><a href="<?=$row['efile']?>" target="_blank" class="btn btn-info btn-sm"> ไฟล์ </a></td>
                            <td><a href="checkpdf.php?e_id=<?= $row['e_id'] ?>" class="btn btn-warning"> ตรวจสอบไฟล์ </a></td>
                            <td><a href="?action=backup&e_id=<?= $row['e_id'] ?>" class="btn btn-danger"
                                    onclick="Del(this.href);return false;"> สำรอง </a></td>
                        </tr>
                    <?php
                    }
...
<script language="JavaScript">
    function Del(mypage) {
        var agree = confirm(" ยืนยันการสำรองข้อมูลหรือไม่? ");
        if (agree) {
