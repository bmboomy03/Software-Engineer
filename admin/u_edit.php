...
<body>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="h4 text-center alert alert-warning mb-5 mt-5" role="alert">แก้ไขสิทธิ์การใช้งาน</div>
        ...
        <div class="col-md-6 mb-3">    
            ...
            <input class="form-control" name="t_id" readonly value = <?= $row['t_id'] ?>>
                ...
                <div align="right">
                    ...
                    <a href="a_home.php" class="btn btn-danger" align=right> ยกเลิก </a>
                </div>
